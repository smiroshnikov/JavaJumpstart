public class Program {
    ...
    public static void main(String[] args) {
        ...
        Pez_1_0 yodaD = new Pez_1_0();
        Pez_1_0 veiderD = new Pez_1_0();

        yodaD.characterName = "This is fucking Yoda!";
        veiderD.characterName = "This is Darth Veider";
        System.out.println("Yoda obj. = " + yodaD.characterName);
        yodaD.characterName = "Bob, scuko Bob!";
        System.out.println("Yoda name parameter has changed to -->  = " + yodaD.characterName);
